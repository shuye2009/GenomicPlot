...
plot_start_end_feature <- function(queryfiles=, querylabels, inputfiles=NULL, inputlabels=NULL, txdb, featureName, CLIP_reads=F, binsize=10, extend_reads=0,
                               longest=T, ext=c(-500, 200, -200, 500), hl=c(-50, 50, -50, 50), randomize=FALSE, stranded=T, norm=F, scale=F, smo=F, heatmap=F,
                               rm.outlier=F, genome="hg19", outprefix="plots"){
...
plot_reference_region <- function(queryfiles=NULL, querylabels=NULL, centerfiles, centerlabels, inputfiles=NULL, inputlabels=NULL, nbins=100, norm=FALSE,
                                  extend_reads=0, CLIP_reads=FALSE, scale=FALSE, heatmap=FALSE, longest=TRUE,
...
plot_reference_locus <- function(queryfiles=NULL, centerfiles=NULL, ext=c(0,0), hl=c(0,0), querylabels=NULL, centerlabels=NULL, smo=FALSE, CLIP_reads=FALSE,
                            extend_reads=0, norm=FALSE, binsize=10, refPoint="center", Xlab="Center", inputfiles=NULL, inputlabels=NULL, stranded=TRUE,
                            stats=FALSE, heatmap=FALSE, scale=FALSE, outPrefix=NULL, genome="hg19", rm.outlier=F){
...
plot_reference_locus_with_random <- function(txdb=NULL, queryfiles=NULL, centerfiles=NULL, ext=c(0,0), hl=c(0,0), querylabels=NULL, centerlabels=NULL,
                                              smo=FALSE,  CLIP_reads=FALSE,  extend_reads=0, norm=FALSE, binsize=10, refPoint="center", Xlab="Center",
                                              inputfiles=NULL, inputlabels=NULL, stranded=TRUE, heatmap=FALSE, scale=FALSE, outPrefix=NULL, genome="hg19",
                                              rm.outlier=F, n_random=1){
