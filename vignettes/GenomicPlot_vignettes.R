...
## ----region2, echo=FALSE, fig.cap="Individual sample mean signal in narrowPeak", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_12.png")

## ----region3, echo=FALSE, fig.cap="Individual sample cumulative signal in narrowPeak", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_13.png")

## ----region4, echo=FALSE, fig.cap="Individual sample signal in narrowPeak violin plot", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_14.png")

## ----region5, echo=FALSE, fig.cap="Individual sample signal in narrowPeak box plot", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_15.png")

## ----region6, echo=FALSE, fig.cap="Individual sample profile and heatmap", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_16.png")

## ----region7, echo=FALSE, fig.cap="Ratio-over-input profile and stats plot", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_region_17.png")

## ----region8, echo=FALSE, fig.cap="Ratio-over-input profile and heatmap", out.width = '75%'----
...
#  hl <- c(-50, 50, -50, 50)
#  
#  handleInputParams <- list(CLIP_reads=TRUE, fix_width=150, fix_point="start", norm=TRUE, useScore=FALSE,
#                            outRle=TRUE, useSizeFactor=TRUE, genome="hg19")
...
## ----locus1, echo=FALSE, fig.cap="Ratio-over-input for clip signal around clip and chip peaks", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus2_13.png")

## ----locus2, echo=FALSE, fig.cap="Ratio-over-input for chip signal around clip and chip peaks", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus2_14.png")

## ----locus3, echo=FALSE, fig.cap="Ratio-over-input for chip and clip signal around clip peaks", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus2_15.png")

## ----locus4, echo=FALSE, fig.cap="Ratio-over-input for chip and clip signal around chip peaks", out.width = '75%'----
...
## ----locus6, echo=FALSE, fig.cap="Ratio-over-input profiles and heatmap for chip and clip signal", out.width = '75%'----
...
## ----locusr1, echo=FALSE, fig.cap="Ratio-over-input for clip signal around clip peaks in 5' UTR", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus_with_random_9.png")

## ----locusr2, echo=FALSE, fig.cap="Ratio-over-input for clip signal around clip peaks in CDS", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus_with_random_10.png")

## ----locusr3, echo=FALSE, fig.cap="Ratio-over-input for clip signal around clip peaks in 3' UTR", out.width = '75%'----
knitr::include_graphics("../tests/test_output/test_plot_locus_with_random_11.png")

## ----locusr4, echo=FALSE, fig.cap="Ratio-over-input for clip signal around clip peaks", out.width = '75%'----
