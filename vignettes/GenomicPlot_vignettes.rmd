...
```
```{r region5, echo = FALSE, fig.cap = "Ratio-over-input profile", out.width = '75%'}
...
```
```{r locus42, echo = FALSE, fig.cap = "Ratio-over-input profile around chip peaks and clip peaks", out.width = '75%'}
knitr::include_graphics("../inst/tests/test_output/test_plot_locus2_7.png")
```
```{r locus5, echo = FALSE, fig.cap = "RRatio-over-input stats around chip peaks and clip peaks", out.width = '75%'}
